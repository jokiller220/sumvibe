...
const FAQS = [
  { q: 'Comment créer un événement ?', a: 'Cliquez sur le bouton "Créer" dans la navigation en bas, remplissez les informations et publiez votre événement.' },
  { q: 'Comment gérer mes agents ?', a: 'Dans l\'espace Profil, accédez à "Mes agents" pour ajouter et gérer vos agents de scan.' },
  { q: 'Comment consulter mes ventes ?', a: 'Dans la navigation, cliquez sur "Ventes" pour voir vos statistiques de ventes en temps réel.' },
  { q: 'Comment recevoir mes paiements ?', a: 'Les paiements sont versés selon le calendrier convenu lors de la création de votre compte organisateur.' },
  { q: 'Comment valider un billet ?', a: 'Utilisez le scanner intégré dans l\'application. L\'agent scanne le QR code du billet à l\'entrée de l\'événement.' },
];

export function OrganizerHelpScreen() {
  const { goBack } = useApp();
